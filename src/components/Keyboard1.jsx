...
export default function Keyboard1() {
  ...
  return (
    <>
      ...
      <div className="row2">
        <button className="btn" onClick={()=>handleClick('a')}>a</button>
        <button className="btn" onClick={()=>handleClick('s')}>s</button>
        <button className="btn" onClick={()=>handleClick('d')}>d</button>
        <button className="btn" onClick={()=>handleClick('f')}>f</button>
        <button className="btn" onClick={()=>handleClick('g')}>g</button>
        <button className="btn" onClick={()=>handleClick('h')}>h</button>
        <button className="btn" onClick={()=>handleClick('j')}>j</button>
        <button className="btn" onClick={()=>handleClick('k')}>k</button>
        <button className="btn" onClick={()=>handleClick('l')}>l</button>
      </div>
      <div className="row2">
